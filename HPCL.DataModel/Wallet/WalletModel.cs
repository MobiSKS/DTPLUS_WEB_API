...
namespace HPCL.DataModel.Wallet
{
    public class SaleLimitsofCards : BaseClass
    {
    ...
    public class CCMSLimitsforAllCards : BaseClass
    {
        public Int64 Customer_id { get; set; }
    ...
    public class CCMSLimitsforIndvCards :BaseClass
    {
    ...
    public class Set_All_Limits_for_Indv_Cards :BaseClass
    {
        public Int64 Customer_id { get; set; }
    ...
    public class SearchcardmappingInput :BaseClass
    {
        public Int64 Customer_id { get; set; }
        public Int64 Card_no { get; set; }
    ...
    public class Searchcardmapping : BaseClass
    {
        public string Cardno { get; set; }
    ...
    public class Deletecardmapping : BaseClass
    {
        public Int64 Customer_id { get; set; }
        public string Cardno { get; set; }
        public string Merchantid { get; set; }
    ...
    public class MapcardtomerchantInput : BaseClass
    {
    ...
    public class DeactivateReactivatecardsInput : BaseClass
    {
    ...
    public class GetEnabledServicesAll_Input
    {
    ...
    public class Get_Enabled_ServicesInput : BaseClass
    {
    ...
    public class DeleteAssignedServices_Input : BaseClass
    {
        public Int64 Cardno { get; set; }
        public Int64 Customer_id { get; set; }
        public Int64 Mobileno { get; set; }
    ...
    public class GetNotAssignedServices_Input : BaseClass
    {
        public Int64 Cardno { get; set; }
        public Int64 Customer_id { get; set; }
        public Int64 Mobileno { get; set; }
    ...
    public class UpdatingServicesInput : BaseClass
    {
        public Int64 Cardno { get; set; }
        public Int64 Customer_id { get; set; }
        public Int64 Mobileno { get; set; }
        public List<Services> Services_Ids { get; set; }
    }
    ...
    public class ReplacementCardsInput : BaseClass
    {
        public Int64 Customer_id { get; set; }
    ...
    public class SearchCardInput : BaseClass
    {
        public Int64? Customer_id { get; set; }
        public Int64? Mobileno { get; set; }
        public Int64? Cardno { get; set; }
    ...
    public class CarddetailsByCardNoInput : BaseClass
    {
        public string Cardno_or_Vehicleno { get; set; }
    }
    ...
    public class ViewCardLimitsInput : BaseClass
    {
        public Int64? Customer_id { get; set; }
    }
    ...
    public class Map_Mobile_NoInput :BaseClass
    {
        public string Mobileno { get; set; }
        public string Cardno { get; set; }
        public string Vehicleno { get; set; }
    ...
    public class BalancebyCustomeridInput : BaseClass
    {
        public Int64? Customer_id { get; set; }
    ...
    public class GetWalletBalanceLimitInput : BaseClass
    {
        public Int64? Card_no { get; set; }
    }

    public class GetWalletBalanceByMobileInput : BaseClass
    {
        public Int64 Mobileno { get; set; }
    ...
    public class LoyaltyBalanceByCardNoInput : BaseClass
    {
    ...
    public class CCMSBalanceByCardNoInput : BaseClass
    {
        public Int64 Controlcardno { get; set; }
        public int Controlpin { get; set; }
        public Int64? Terminal_Id { get; set; }
    ...
    public class Request_otc_card_by_region_Input : BaseClass
    {
    ...
    public class Request_otc_card_by_merchant_Input : BaseClass
    {
    ...
    public class Viewrequestedotccardbyregion_Input : BaseClass
    {
        public int Region_id { get; set; }
        public int Card_Type { get; set; }
    ...
    public class Viewrequestedotccardbyregion : BaseClass
    {
    ...
    public class GetPointEquivAmtInput : BaseClass
    {
    ...
    public class SaveDTPLoyaltyByCard_Input : BaseClass
    {
    ...
    public class SaveDTPLoyaltyByMobileNo_Input : BaseClass
    {
        public int ROC_No { get; set; }
        public Int64 Mobile_no { get; set; }
        public decimal Amount { get; set; }
    ...
    public class SaveNonDTPLoyaltyByCard_Input : BaseClass
    {
        public Int64? Card_no { get; set; }
        public decimal? Amount { get; set; }
        public int? Terminal_Pin { get; set; }
    ...
    public class SaveNonDTPLoyaltyByMobileNo_Input : BaseClass
    {
        public Int64 Mobile_No { get; set; }
        public decimal? Amount { get; set; }
        public int? Terminal_Pin { get; set; }
    ...
    public class CheckTransactionValuevsLimit_Input : BaseClass
    {
        public Int64 Card_No { get; set; }
    ...
    public class Add_On_Card_Aggregator_Customer_Input : BaseClass
    {
    ...
    public class List_of_Pending_Card_Input : BaseClass
    {
