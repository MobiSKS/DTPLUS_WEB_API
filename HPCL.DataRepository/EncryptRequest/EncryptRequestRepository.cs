...
{
    public class EncryptRequestRepository : IEncryptRequestRepository
    {
        private readonly DapperContext _context;
        public EncryptRequestRepository(DapperContext context)
        {
            _context = context;
        }

        public async Task<object> EncryptRequest([FromBody] LoginModel ObjUser)
        {
