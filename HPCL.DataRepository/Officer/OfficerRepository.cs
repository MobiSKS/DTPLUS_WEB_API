...
namespace HPCL.DataRepository.Officer
{
    public class OfficerRepository : IOfficerRepository
    {
        ...
        public async Task<IEnumerable<InsertRBEOfficerModelOutput>> InsertRBEOfficer([FromBody] InsertRBEOfficerModelInput ObjClass)
        {
            var procedureName = "UspInsertOfficer";
            var parameters = new DynamicParameters();
            parameters.Add("FirstName", ObjClass.FirstName, DbType.String, ParameterDirection.Input);
            ...
            parameters.Add("Password", ObjClass.Password, DbType.String, ParameterDirection.Input);
            using var connection = _context.CreateConnection();
            return await connection.QueryAsync<InsertRBEOfficerModelOutput>(procedureName, parameters, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task<IEnumerable<GetOfficerCreationApprovalModelOutput>> BindRBEDetail([FromBody] GetOfficerCreationApprovalModelInput ObjClass)
        {
            ...
            parameters.Add("UserName", ObjClass.UserName, DbType.String, ParameterDirection.Input);
            using var connection = _context.CreateConnection();
            return await connection.QueryAsync<GetOfficerCreationApprovalModelOutput>(procedureName, parameters, commandType: CommandType.StoredProcedure);
        }
        ...
        public async Task<IEnumerable<OfficerALDealerEnrollmentModelOutput>> InsertALDealerEnrollment([FromBody] OfficerALDealerEnrollmentModelInput ObjClass)
        {
            ...
            parameters.Add("Userip", ObjClass.Userip, DbType.String, ParameterDirection.Input);
            using var connection = _context.CreateConnection();
            return await connection.QueryAsync<OfficerALDealerEnrollmentModelOutput>(procedureName, parameters, commandType: CommandType.StoredProcedure);
        }

        public async Task<IEnumerable<OfficerUpdateALDealerEnrollmentModelOutput>> UpdateALDealerEnrollment([FromBody] OfficerUpdateALDealerEnrollmentModelInput ObjClass)
        {
            ...
            parameters.Add("Userip", ObjClass.Userip, DbType.String, ParameterDirection.Input);
            using var connection = _context.CreateConnection();
            return await connection.QueryAsync<OfficerUpdateALDealerEnrollmentModelOutput>(procedureName, parameters, commandType: CommandType.StoredProcedure);
        }

        public async Task<IEnumerable<OfficerGetDealerNameModelOutput>> GetALDealerDetail([FromBody] OfficerGetDealerNameModelInput ObjClass)
        {
