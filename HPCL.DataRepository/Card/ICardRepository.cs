...
namespace HPCL.DataRepository.Card
{
    public interface ICardRepository
    {
        ...
        public Task<GetCardsForLimitUpdateForSingleRechargeModelOutput> GetCardsForLimitUpdateForSingleRecharge([FromBody] GetCardsForLimitUpdateForSingleRechargeModelInput ObjClass);
